 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Yn(E1,w1,"app");const T1={apiKey:"AIzaSyBUqvUymKLeSQSyEGiLCh9Hxh1-eyMv6vw",authDomain:"metro-29872.firebaseapp.com",projectId:"metro-29872",storageBucket:"metro-29872.firebasestorage.app",messagingSenderId:"743150289722",appId:"1:743150289722:web:8511e7e5ffd32cc9bb0603",measurementId:"G-LTGBJH4MMM"},fw=hv(T1),ga=uP(fw),ya=Xk(fw);function I1(){const[t,e]=Tt.useState(null),[n,r]=Tt.useState([]),[i,s]=Tt.useState(""),[o,l]=Tt.useState(""),[u,h]=Tt.useState(""),[f,m]=Tt.useState(!0),[y,A]=Tt.useState(!1);Tt.useEffect(()=>{const I=XA(ga,async V=>{if(V){e({uid:V.uid,email:V.email,displayName:V.displayName});const F=await V.getIdTokenResult();A(F.claims.admin===!0)}else e(null),A(!1)});return()=>I()},[]),Tt.useEffect(()=>{if(!t)return;const I=u1(jg(ya,"todos"),c1("createdAt","desc")),V=_1(I,F=>{const U=[];F.forEach(v=>{U.push({id:v.id,...v.data()})}),r(U)});return()=>V()},[t]);const k=async I=>{I.preventDefault();try{f?await GA(ga,o,u):await KA(ga,o,u),l(""),h("")}catch(V){alert("Fehler: "+V.message)}},D=()=>JA(ga),L=async I=>{I.preventDefault(),!(!i.trim()||!t)&&(await y1(jg(ya,"todos"),{text:i,completed:!1,createdBy:t.email,createdAt:Date.now(),updatedAt:Date.now()}),s(""))},S=async I=>{const V=Ph(ya,"todos",I.id);await m1(V,{completed:!I.completed,updatedAt:Date.now()})},E=async I=>{if(!y){const V=n.find(F=>F.id===I);if(V&&V.createdBy!==(t==null?void 0:t.email)){alert("Only admins can delete other users' todos");return}}await g1(Ph(ya,"todos",I))};return t?le.jsxs("div",{className:"app",children:[le.jsxs("header",{children:[le.jsx("h1",{children:"Familien To-Do Liste"}),le.jsxs("div",{className:"user-info",children:[le.jsx("span",{children:t.email}),y&&le.jsx("span",{className:"admin-badge",children:"👑 Admin"}),le.jsx("button",{onClick:D,children:"Abmelden"})]})]}),le.jsxs("form",{onSubmit:L,className:"add-todo",children:[le.jsx("input",{type:"text",placeholder:"Neue Aufgabe...",value:i,onChange:I=>s(I.target.value)}),le.jsx("button",{type:"submit",children:"Hinzufügen"})]}),le.jsx("ul",{className:"todo-list",children:n.map(I=>le.jsxs("li",{className:I.completed?"completed":"",children:[le.jsx("input",{type:"checkbox",checked:I.completed,onChange:()=>S(I)}),le.jsx("span",{children:I.text}),le.jsxs("small",{children:["von ",I.createdBy]}),le.jsx("button",{onClick:()=>E(I.id),children:"Löschen"})]},I.id))})]}):le.jsx("div",{className:"app",children:le.jsxs("div",{className:"auth-container",children:[le.jsx("h1",{children:"Familien To-Do Liste"}),le.jsxs("form",{onSubmit:k,children:[le.jsx("input",{type:"email",placeholder:"Email",value:o,onChange:I=>l(I.target.value),required:!0}),le.jsx("input",{type:"password",placeholder:"Passwort",value:u,onChange:I=>h(I.target.value),required:!0}),le.jsx("button",{type:"submit",children:f?"Anmelden":"Registrieren"})]}),le.jsx("button",{onClick:()=>m(!f),children:f?"Noch kein Account? Registrieren":"Schon registriert? Anmelden"})]})})}cc.createRoot(document.getElementById("root")).render(le.jsx(aT.StrictMode,{children:le.jsx(I1,{})}));
